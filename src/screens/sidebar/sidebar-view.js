  ...
  return (
    <div>
      <div>
        <nav
          href="#navbar"
          className="js-template-nav-toggle template-nav-toggle"
        ...
        <aside id="template-aside" className="border js-fullheight">
          <div className="text-center">
            ...
            <h1 id="template-logo">
              <a href="index.html">
                <span className="sidebar-firstname">{info.firstname}</span>
                <span className="sidebar-lastname">{info.lastname}</span>
              </a>
            </h1>
          </div>
          <nav id="template-main-menu" role="navigation" className="navbar">
            <div id="navbar" className="collapse">
              <ul>
                ...
                <li>
                  <a href="#achievemts" data-nav-section="achievements">
                    Achievements
                  </a>
                </li>
          ...
          <nav id="template-footer">
            <div className="some-links">
              ...
              <a
                className="some-link"
                href="https://www.linkedin.com/in/arnab-roy-600403a1/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <i className="icon-linkedin2 some-icon" />
              </a>
              <a
                className="some-link"
                ...
                rel="noopener noreferrer"
              >
                <i className="icon-github some-icon" />
              </a>
              <a
                className="some-link"
                href="https://stackoverflow.com/users/9041122/arnab-roy"
                target="_blank"
                rel="noopener noreferrer"
              >
                <i className="icon-stackoverflow some-icon" />
              </a>
            </div>
          </nav>
        </aside>
